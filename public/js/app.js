...
async function openModal(id) {
  ...
  modalEl.innerHTML = `
    <div class="modal__card" >
      ...
      <form  method="post"  >
      <input class="box" type="hidden" name="image" value="${respData.posterUrl}" />
      <input class="box" type="hidden" name="name" value="${respData.nameRu}" />
      <input class="box" type="hidden" name="year" value="${respData.year}" />
      <input class="box" type="hidden" name="genre" value="${respData.genres.map((el) => ` ${el.genre}`)}" />
      <input class="box" type="hidden" name="duration" value="${respData.filmLength}" />
